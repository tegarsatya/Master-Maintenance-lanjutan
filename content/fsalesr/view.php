...
<?php
	...
	$read	= $conn->prepare("SELECT A.kode_tsl, A.subtot_tsl, A.ppn_tsl, A.total_tsl, A.tgl_tsl, B.nama_out FROM transaksi_sales_r AS A LEFT JOIN outlet AS B ON A.id_out=B.id_out WHERE A.id_tsl=:kode");
