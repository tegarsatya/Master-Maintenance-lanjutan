...
<input type="hidden" name="cariitem" id="cariitem" value="<?php echo($cari1); ?>" readonly="readonly" />
...
<div class="content-body">
    <div class="row mg-b-10">
        <div class="col-sm-6">
            ...
            <a href="#modal1" onclick="<?php echo("cariitem('cariitem', 'inventory', '$carii')"); ?>" data-toggle="modal"><button class="btn btn-danger btn-pill btn-xs"><i class="fa fa-plus-circle"></i> Transfer Stok</button></a>
        </div>
        <div class="col-sm-6">
