<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Faktur Pinjaman</h4>
    </div>
</div>
...
<div class="content-body">
	<div class="row mg-b-10">
        <div class="col-sm-6">
			...
			<a href="<?php echo($data->sistem('url_sis').'/fsalesp'); ?>"><button class="btn btn-info btn-pill btn-xs"><i class="fa fa-spinner"></i> Refresh</button></a>
        </div>
        <div class="col-sm-6">
