<?php
	...
	$read	= $conn->prepare("SELECT sj_tfk, id_out, kode_tfk FROM transaksi_faktur_l WHERE id_tfk=:code");
...
<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Input Item - Faktur Lain - Lain</h4>
...
<div class="content-body">
    <div class="component-section no-code">
        ...
        <div class="row row-sm">
            <div class="col-sm-12">
                <a href="<?php echo("$sistem/fsalesl"); ?>" title="Batal"><button type="button" class="btn btn-secondary">Batal</button></a>
